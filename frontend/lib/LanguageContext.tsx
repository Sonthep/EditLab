...
export const translations = {
  en: {
    ...
    step_3: "Trim dead air (Q/W ripple cut), cut on finished thoughts, and keep shot lengths tight.",
    step_4: "Export as 1080p H.264 MP4 on the Deliver Page, then submit below.",
    capcut_workflow_title: "CapCut Desktop Workflow",
    capcut_step_1: "Open CapCut Desktop, set canvas to 9:16 or 16:9, and drag raw_footage.mp4 to main track.",
    capcut_step_2: "Press Ctrl+B (Cmd+B) to split clip on pauses, then press Delete to ripple trim dead air.",
    capcut_step_3: "Drag B-roll clips onto the upper track (Overlay) to cover jump cuts and add punch zooms.",
    capcut_step_4: "Click Export (Top Right), choose 1080p H.264 MP4, then submit your video below.",
    btn_view_full_guide: "View Complete Software Guide →",
    ...
    // Markers & Safe Zone & Sharing
    btn_export_markers: "Export Markers",
    export_markers_title: "Export Timeline Markers",
    export_markers_sub: "Import coaching notes directly onto your DaVinci Resolve or Premiere Pro timeline.",
    btn_download_edl: "DaVinci Resolve EDL (.edl)",
    btn_download_csv: "Universal Marker CSV (.csv)",
    edl_desc: "Color-coded markers for DaVinci Resolve 18/19: Green = Good, Yellow = Pacing/Cut, Red = Dead Air, Cyan = Audio.",
    csv_desc: "Compatible with Premiere Pro, Final Cut Pro, and DaVinci Resolve with timecodes and descriptions.",
    nle_import_guide_title: "How to Import into DaVinci Resolve",
    nle_import_step1: "In Media Pool, right-click your Timeline -> Timelines -> Import -> Timeline Markers from EDL...",
    nle_import_step2: "Select the downloaded .edl file. Markers appear at the exact timestamps with coaching notes!",
    safe_zone_label: "Safe Zone & Grid",
    safe_zone_off: "Off",
    safe_zone_tiktok: "TikTok (9:16)",
    safe_zone_reels: "IG Reels (9:16)",
    safe_zone_shorts: "YT Shorts (9:16)",
    safe_zone_grid: "3x3 Grid",
    btn_print_report: "Print / Save PDF",
    btn_share_card: "Share Performance",
    share_card_title: "EditLab Editor Performance Card",
    btn_copy_summary: "Copy Summary Text",
    ...
    btn_testing_connection: "Testing...",
    get_api_key_hint: "Get a free API key at Google AI Studio",
    api_key_set_badge: "Key is securely configured",
  ...
  th: {
    ...
    davinci_workflow_title: "ขั้นตอนการทำงานใน DaVinci Resolve 19",
    step_1: "คลิก 'เปิดโฟลเดอร์ในเครื่อง' เพื่อเข้าถึงไฟล์ raw_footage.mp4",
    step_2: "ลากคลิปลงไทม์ไลน์ในหน้า Edit ของ DaVinci Resolve",
    step_3: "ตัด Dead air (ใช้คีย์ลัด Q/W ripple cut), คัตตามความคิด และคุมช็อตให้กระชับ",
    step_4: "Export เป็น 1080p H.264 MP4 ในหน้า Deliver แล้วนำมาส่งตรวจด้านล่าง",
    capcut_workflow_title: "ขั้นตอนการทำงานใน CapCut Desktop",
    capcut_step_1: "เปิด CapCut Desktop ตั้งสัดส่วน 9:16 หรือ 16:9 แล้วลากไฟล์ raw_footage.mp4 ลง Track หลัก",
    capcut_step_2: "กด Ctrl+B (Cmd+B) ตัดแยกคลิปตรงช่วงหยุด แล้วกด Delete เพื่อลบ Dead air ทิ้งทันที",
    capcut_step_3: "ลากคลิป B-roll ซ้อนแทร็กด้านบน (Overlay) เพื่อปิดรอยต่อคำพูด และใส่ Punch Zoom 115%",
    capcut_step_4: "กดปุ่ม Export มุมขวาบน เลือก 1080p H.264 MP4 แล้วนำไฟล์มาส่งตรวจด้านล่าง",
    btn_view_full_guide: "ดูคู่มือโปรแกรมฉบับเต็ม →",
    ...
    // Markers & Safe Zone & Sharing
    btn_export_markers: "ส่งออก Markers",
    export_markers_title: "ส่งออก Timeline Markers เข้าโปรแกรมตัดต่อ",
    export_markers_sub: "นำคำแนะนำและจุดตัดของโค้ชไปขึ้นเป็นหมุดสีบนไทม์ไลน์ใน DaVinci Resolve หรือ Premiere Pro ทันที",
    btn_download_edl: "DaVinci Resolve EDL (.edl)",
    btn_download_csv: "Universal Marker CSV (.csv)",
    edl_desc: "ไฟล์ Marker สำหรับ DaVinci Resolve 18/19 แยกสีอัตโนมัติ: เขียว = จุดที่ดี, เหลือง = จุดปรับจังหวะ, แดง = Dead Air, ฟ้า = เสียง",
    csv_desc: "รองรับ Premiere Pro, Final Cut Pro และ DaVinci Resolve พร้อมระบุ Timecode และคำแนะนำ",
    nle_import_guide_title: "วิธีนำเข้า Markers ใน DaVinci Resolve",
    nle_import_step1: "ใน Media Pool คลิกขวาที่ Timeline -> Timelines -> Import -> Timeline Markers from EDL...",
    nle_import_step2: "เลือกไฟล์ .edl ที่ดาวน์โหลดมา หมุดสีพร้อมคำแนะนำจะปรากฏบนไทม์ไลน์ตรงจุดทันที!",
    safe_zone_label: "Safe Zone และเส้นกริด",
    safe_zone_off: "ปิด",
    safe_zone_tiktok: "TikTok (9:16)",
    safe_zone_reels: "IG Reels (9:16)",
    safe_zone_shorts: "YT Shorts (9:16)",
    safe_zone_grid: "กฎสามส่วน (3x3)",
    btn_print_report: "พิมพ์ / บันทึก PDF",
    btn_share_card: "แชร์การ์ดคะแนน",
    share_card_title: "การ์ดสรุปผลงานตัดต่อ EditLab",
    btn_copy_summary: "คัดลอกข้อความสรุป",
    summary_copied: "คัดลอกข้อความแล้ว!",
    ...
    opt_gemini: "Google Gemini API (Generative Video Coaching)",
    gemini_model_label: "โมเดล Gemini",
    gemini_key_label: "Gemini API Key",
    btn_test_connection: "ทดสอบการเชื่อมต่อ",
    btn_testing_connection: "กำลังทดสอบ...",
    get_api_key_hint: "ขอรับ API Key ฟรีได้ที่ Google AI Studio",
    api_key_set_badge: "บันทึกคีย์เรียบร้อยแล้ว",
